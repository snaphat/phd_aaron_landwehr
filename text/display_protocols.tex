...
\section{Classical Display Protocols}
    ...
    \begin{table}
        ...
        \begin{tabular}{| c c c c c |}
            \hline
                ...
                & $f_p$ & $h_a \quad h_{SS} \quad h_{SE} \quad h_{T}$ & $v_a \quad v_{SS} \quad v_{SE} \quad v_{T}$ &
                \\
    ...
    \begin{equation}
        \begin{array}{ l l l l }
            h_a=1920 & h_{fp}=h_{SS}-h_a & h_{sp}=h_{SE}-h_{SS} & h_{bp}=h_T-h_{SE} \\
    ...
    \begin{equation}
        \begin{array}{ l l l l }
            v_a=1080 & v_{fp}=v_{SS}-v_a & v_{sp}=v_{SE}-v_{SS} & v_{bp}=v_T-v_{SE} \\
