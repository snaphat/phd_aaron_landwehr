...
\section{Display Protocols within IRSP Technology}
    ...
    Now that the background of display protocols has been discussed, Chapter~\ref{chap:pdp_protocol} shifts to a discussion of PDP's design itself followed by a protocol specification.
