...
The relative array size is shown in Figure~\ref{fig:tcsa_nsleds_hdiled_array_ratio}.
\begin{figure}
    \centering
    \includegraphics[trim=0.5in 0.5in 0.5in 1.5in,width=1.0\textwidth]{fig/tcsa_nsleds_hdiled_array_ratio.pdf}
    \caption{SLEDs Array Ratios}
...
\section{Array Drawing Process}
    ...
    \begin{figure}
        ...
        \caption[NSLEDs and HIDLED Array Layouts]{NSLEDs and HIDLED Array Layouts\textsuperscript{a}}
        \vspace{-8px}
