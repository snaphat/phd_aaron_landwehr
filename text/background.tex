...
\section{Close Support Electronics}
    As mentioned briefly in Section~\ref{sec:irled_projector_systems}, some form of CSE is needed to drive IRLED arrays. TCSA, NSLEDS, and HDILED can all be driven using the same electronics. Figure~\ref{fig:sleds_block} shows internals of the CSE broken out. The combined internals are shown in Figure~\ref{fig:nessie_enclosure_internals}.
