    ...
    \subsection{Characterization}
        ...
        \subsubsection{Non-uniformity Corrected Imagery}
            ...
            \begin{figure}[t]
                ...
                \caption{Non-uniformity Corrected Image Drawn with PDP Firmware at 100Hz}
                \label{fig:pdp_bird}
            \end{figure}
...
\section{Packetized Operation}
    ...
    \subsection{Normal-speed}
        ...
        \begin{figure}[t]
            \centering
            \includegraphics[width=0.25\textwidth]{fig/low_speed_numbers.png}
    ...
    \subsection{High-speed}
        ...
        \begin{figure}[t]
            \centering
            \includegraphics[width=0.25\textwidth]{fig/high_speed_object.png}
        ...
        \begin{figure}[t]
            \centering
            \includegraphics[width=1.0\textwidth]{fig/high_speed_numbers.png}
        ...
        \begin{figure}[t]
            \centering
            \includegraphics[width=1.0\textwidth]{fig/high_speed_rotating_object.png}
