...
\section{Packetized Operation}
    ...
    \subsection{Multi-frame Rate}
        ...
        \begin{figure}[t]
            \centering
            \includegraphics[width=0.85\textwidth]{fig/pdp_multi_frame_rate.jpg}
