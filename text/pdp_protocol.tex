...
\section{Design Methodology}
    ...
    Design goal 1 will be touched upon throughout this chapter and Chapters~\ref{chap:machine_model}. Design goal 2 will be touched upon in Chapters~\ref{sec:packet_format}~and~\ref{sec:packet_types}. Design goal 3 will be touched upon in Chapter~\ref{sec:multi_framerate_performance}. Design goal 4 will be touched upon in Chapters~\ref{sec:packet_format},~\ref{sec:packet_types},~and~\ref{chap:implementation}.
