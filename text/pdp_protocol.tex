...
\section{Compositing}
    ...
    This section discusses a possible compositing layer analysis that could be implemented into a system utilizing PDP to show another possible use case for PDP. Compositing is the process of combining two or more images into a single picture. In high speed systems imagery could be generated in individual pieces and combined via a compositor layer. This process might be done by a single system or via separate systems. For purposes of this discussion, it is assumed all data has arrived and is avaliable for analysis by a compositing layer.
